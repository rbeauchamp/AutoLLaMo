...
public static class AssistantRolePromptContentGenerator
{
    public static AssistantRolePromptContent GenerateContent(this AssistantConfig assistantConfig)
    {
        ...
        return new AssistantRolePromptContent
        {
            ...
            UsefulContext =
                "All system and user role messages in this conversation are generated by AutoLLaMo, an open-source GitHub project written in C#. The primary goal of the project is to enable goal-driven AI assistants like you, in any domain, to autonomously achieve a user's desire. The repo URL is https://github.com/rbeauchamp/AutoLLaMo. Use this useful context to recursively improve AutoLLaMo and therefore enhance your ability to achieve your goals.",
            Constraints = new List<string>
            {
                "As an AI, you can't directly access real-time data or change the external world. Instead, select an available command to execute and use the provided output to inform further conversation. Base decisions on your training knowledge as well as the conversation context and avoid assumptions about the external world.",
            ...
            {
                "Your response must include a next command to execute, exclusively selected from the list of available commands below.",
            },
